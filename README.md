...
A high-performance, responsive web application for booking movie theater tickets built with **React 19**, **TypeScript**, **Redux Toolkit 2 (RTK Query + Redux Saga)**, **Webpack 5 + SWC**, **Ant Design v5**, and **TailwindCSS**.

---

## ✨ Features & Architecture Highlights

- ⚡ **High-Performance Build System:** Built on standalone **Webpack 5** with `@swc/loader` ES2022 TSX compilation, split chunk optimization, and asset inline optimization.
...
- 🚀 **Redux Toolkit Query (RTK Query) + Redux Saga:** Declarative data fetching, background caching, and tag invalidation via RTK Query alongside Redux Saga for complex authentication & booking side-effects.
...
| **State Management** | Redux Toolkit 2, RTK Query, Redux Saga |
| **Styling & UI** | TailwindCSS v3, Ant Design v5, `@ant-design/icons` |
| **Form Management** | React Hook Form, `@hookform/resolvers`, Zod |
| **Build & Bundling** | Webpack 5, SWC (`swc-loader`), `MiniCssExtractPlugin` |
| **Date & Time** | Day.js |
...
│   ├── auth/             # Login, Register, Auth Layout & Schemas
...
└── shared/               # Shared cross-cutting components & utilities
    ...
    ├── services/         # RTK Query movieApi slice
...
REACT_APP_TOKEN_CYBERSOFT=YOUR_CYBERSOFT_TOKEN
